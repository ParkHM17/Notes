...
![线程状态转换](多线程.assets/ace830df-9919-48ca-91b5-60b193f593d2.png)
...
>
> [思否](https://segmentfault.com/a/1190000037589073)
...
![happens-before](多线程.assets/java-thread-x-key-schronized-3.png)
...
![happens-before关系](多线程.assets/java-thread-x-key-volatile-1.png)
...
![屏障](多线程.assets/java-thread-x-key-volatile-3.png)

![屏障](多线程.assets/java-thread-x-key-volatile-4.png)
...
![ThreadLocal](多线程.assets/threadlocal数据结构.a0bfadf8.png)
