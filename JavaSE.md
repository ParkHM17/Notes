...
> 参考链接：[简书](https://www.jianshu.com/p/07c78662c210)

|          |                           成员变量                           |                      局部变量                      |
| :------: | :----------------------------------------------------------: | :------------------------------------------------: |
| 语法形式 | 属于类，可以被`public`，`private`，`static`，`final`等修饰，被`static`修饰的称作**静态变量** |                   被`final`修饰                    |
| 存储方式 |             成员变量在堆的对象中，静态变量在堆中             |                         栈                         |
| 生存时间 |       从对象创建（加载类）开始到对象销毁（销毁类）结束       | 随着方法的调用而自动生成，随着方法的调用结束而消亡 |
